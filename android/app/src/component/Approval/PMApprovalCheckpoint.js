                    ...
                    {checkpoints.map((item, index) => (
                        <View key={index} style={[
                            ...
                            <View style={styles.row2}>
                                ...
                                <TextInput
                                    style={[styles.input2, { width: 250, marginEnd: '-20' }]}
                                    multiline={true}
                                    numberOfLines={4}
                                ...
                                <TouchableOpacity
                                    style={{
                                        width: '6%', backgroundColor: '#0059b3', paddingVertical: '4', paddingHorizontal: '4', marginRight: '-30'
                                        , alignItems: 'center'
                                    }} >
                                    <Text style={styles.buttonText}>OK</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    style={{ width: '6%', backgroundColor: '#0059b3', paddingVertical: '4', paddingHorizontal: '4', alignItems: 'center' }} >
